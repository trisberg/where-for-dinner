...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"msgbroker-crossplane-where-for-dinner","artifactVersion":"0.0.1-beta","gatewayName":"gateway-where-for-dinner","dynamicMsgBroker":true,"dbType":"h2","enableCloudEvents":false,"empty":"","enableSecurity":false,"gatewayType":"ossscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"secureProfile":"secure","appWorkloadURL":"http://where-for-dinner.default.apps.35.188.81.125.nip.io","artifactId":"where-for-dinner","serviceNamespace":"service-instances","msgBrokerType":"rabbitmq","projectName":"where-for-dinner","workloadNamespace":"default","cacheType":"inmemCache","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input11371635532321575044, --data-values-file, /tmp/accelerator-options10720909325841000175.json, --output-files, /tmp/ytt-output14605966796931597661]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug doc/images/KnativeEventing.png didn't match [**/dynamicRabbitMQCluster.yaml] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug templates/knEventing.yaml didn't match [**/dynamicRabbitMQCluster.yaml] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"msgbroker-crossplane-where-for-dinner","artifactVersion":"0.0.1-beta","gatewayName":"gateway-where-for-dinner","dynamicMsgBroker":true,"dbType":"h2","enableCloudEvents":false,"empty":"","enableSecurity":false,"gatewayType":"ossscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"secureProfile":"secure","appWorkloadURL":"http://where-for-dinner.default.apps.35.188.81.125.nip.io","artifactId":"where-for-dinner","serviceNamespace":"service-instances","msgBrokerType":"rabbitmq","projectName":"where-for-dinner","workloadNamespace":"default","cacheType":"inmemCache","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input17089649073826473434, --data-values-file, /tmp/accelerator-options3509733435993908234.json, --output-files, /tmp/ytt-output9969156009980045427]
